...
const normalbutter = new ingredient("Butter", TBSP, 0.09);
...
const cornstarch = new ingredient("Corn Starch", TSP, 0.033);
...
const cocoa = new ingredient("Cocoa", TBSP, 0.22);
...
const pumpkin = new ingredient("Can of Pumpkin", SINGLE, 1.97);
const yogurt = new ingredient("Yogurt", CUP, 0.69);
const creamoftartar = new ingredient("Cream of Tartar", TBSP, 1.30);
const poppyseeds = new ingredient("Poppy Seeds", TBSP, 0.52);
const molasses = new ingredient("Molasses", TBSP, 0.08);
const lemons = new ingredient("Lemons", SINGLE, 0.1);
const ginger = new ingredient("Ginger", TBSP, 0.12);
const sourcream = new ingredient("Sour Cream", TBSP, 0.09);
const lemonjuice = new ingredient("Lemon Juice", TBSP, 0.03);
const maplesyrup = new ingredient("Maple Syrup", TBSP, 0.19);